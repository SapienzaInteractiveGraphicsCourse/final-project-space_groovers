...
To access directly to the game, click the following link:
...
Left / Right Arrows
Yaw Left / Right
Up / Down Arrows (or Q / E)
Pitch Up / Down
R
Extend / Retract Robotic Arm
G
Grab / Release Crystal
P
Deploy / Fold Solar Panels (Recharge)
C
Toggle Cockpit (First-Person) / Third-Person Camera
Left Click + Drag
Orbit Camera View
Mouse Wheel
Zoom In / Out
...
Installation & Run
If you want to enter the game through local download, follow the steps reported below:
Clone or extract the repository into your local workspace:
Bash
git clone https://github.com/samueleCostantinopoli/IG-Project.git
cd IG-Project
...
Bash
npm run dev
Open the displayed local address (usually http://localhost:5173) in any WebGL-compatible modern browser.
Project Structure
Plaintext
├── public/
